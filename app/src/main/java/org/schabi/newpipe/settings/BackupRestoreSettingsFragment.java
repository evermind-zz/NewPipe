...
public class BackupRestoreSettingsFragment extends BasePreferenceFragment {
    ...
    public void onCreatePreferences(@Nullable final Bundle savedInstanceState,
        ...
        exportDataPreference.setOnPreferenceClickListener((final Preference p) -> {
            NoFileManagerSafeGuard.launchSafe(
                    ...
                    StoredFileHelper.getNewPicker(requireContext(),
                            "BravePipeData-" + exportDateFormat.format(new Date()) + ".zip",
                            ZIP_MIME_TYPE, getImportExportDataUri()),
                    TAG,
                    getContext()
            );
        ...
        final Preference exportSubsPreference = requirePreference(R.string.export_subscriptions);
        exportSubsPreference.setOnPreferenceClickListener(reference -> {
            importExportHelper.onExportSelected();
            return true;
        });

        final Preference importSubsPreference = requirePreference(R.string.import_subscriptions);
